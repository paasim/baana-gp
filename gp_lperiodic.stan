...
data {
  ...
  real<lower=0> m_cross_pe;   // mean number of times trend in period crosses 0 in a year
...
generated quantities {
  ...
  vector[N2] y2;        // predictions of y at all points
  {
    ...
    matrix[N1, N2] K12 = cov_lperiodic(x1_d, x2_d, alpha_pe, rho_se, rho_pe, gamma) +
                          cov_ard(x1_w, x2_w, alpha_ard, rho_ard);
    matrix[N2, N2] K22 = cov_lperiodic_s(x2_d, alpha_pe, rho_se, rho_pe, gamma) +
